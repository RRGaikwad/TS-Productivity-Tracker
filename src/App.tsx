...
import { GoalProvider } from './stores/GoalContext';
...
function AuthPage() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-950 flex items-center justify-center transition-colors">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">Loading TechSuccession…</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center px-4 transition-colors">
      <div className="max-w-md w-full bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-800 p-8">
        <div className="flex items-center justify-center gap-2 mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">TechSuccession</h1>
        </div>
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-3 bg-white dark:bg-slate-900 text-gray-400 uppercase tracking-wide">Or continue with email</span>
          </div>
        </div>
